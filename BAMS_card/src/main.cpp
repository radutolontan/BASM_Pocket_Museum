...
long roundToNearest50(int32_t num) {
    return ((num + 25) / 50) * 50;
}
...
void loop()
{
  ...
  Serial.print(F("Pressure..........: ")); Serial.print(roundToNearest50(myBMP.getPressure()));       Serial.println(F(" +-100Pa"));
  ...
  */
  //Serial.print(F("See level pressure: ")); Serial.print(myBMP.getSeaLevelPressure(100)); Serial.println(F(" Pa"));
  //Serial.print(F("WX Code: ")); Serial.print(myBMP.getForecast(100)); Serial.println(F(" over"));
